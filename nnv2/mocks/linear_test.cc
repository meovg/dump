...
void test_add_bias_to_output(void) {
    ...
    add_bias_to_output(&output, &bias);
...
void test_propagate_linear_gradient(void) {
    ...
    propagate_linear_gradient(&input_grad, &weights_grad, &input, &weights, &output_grad);
...
void test_propagate_bias_gradient(void) {
    ...
    propagate_bias_gradient(&bias_grad, &output_grad);
